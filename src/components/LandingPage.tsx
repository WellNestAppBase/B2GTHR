  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white">
      ...
      <section className="py-24 bg-[#0a0a0a] relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-purple-900/5 to-pink-900/5 z-0"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            {/* New container for paragraphs */}
            <div className="max-w-4xl mx-auto bg-gradient-to-br from-gray-900/80 to-black/80 p-8 rounded-xl border border-gray-800 shadow-xl mb-12 backdrop-blur-sm">
              <p className="text-lg text-gray-300 leading-relaxed">
                Say hello to B2GTHR (Be Together - Better Together)—the app that
                brings your loved ones closer, no matter where life takes you.
                It's more than a way to stay in touch; it's a promise to be
                there for each other, a heartbeat of support that keeps your
                inner circle tight. B2GTHR lets you share how you're feeling
                with those who matter most, so they know when you're soaring or
                when you need them by your side. It's the comfort of knowing
                someone's got your back, the joy of celebrating together, and
                the strength of showing up for one another in life's biggest
                moments.
              </p>
              <div className="h-px w-full bg-gradient-to-r from-transparent via-pink-500/30 to-transparent my-6"></div>
              <p className="text-lg text-gray-300 leading-relaxed">
                This app is your bridge across distance and busy days, making
                connection feel effortless and real. Whether it's a quiet
                check-in with family, a rally cry for support, or simply feeling
                closer to your best friend, B2GTHR weaves your lives together
                with care and trust. It's about being present, being needed, and
                being together—exactly when it counts.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-gradient-to-br from-gray-900/70 to-black/70 p-8 rounded-xl border border-gray-800 hover:border-pink-500/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-500/10 group">
            ...
            <div className="bg-gradient-to-br from-gray-900/70 to-black/70 p-8 rounded-xl border border-gray-800 hover:border-purple-500/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-purple-500/10 group">
            ...
            <div className="bg-gradient-to-br from-gray-900/70 to-black/70 p-8 rounded-xl border border-gray-800 hover:border-blue-500/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/10 group">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-8 w-8 text-white"
                  fill="none"
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-2xl mx-auto bg-gray-900/50 p-8 rounded-lg border border-gray-800 mb-10">
            <div className="space-y-6">
              <div className="flex items-center justify-center p-3 bg-gray-900/30 rounded-lg mb-4 hover:bg-gray-900/50 transition-all duration-300 group">
                <a
                ...
                >
                  <EmailIcon size={28} />
                  <span className="text-pink-400 group-hover:text-pink-300 transition-colors duration-300 font-medium">
                    WellNestAppDev@gmail.com
                  </span>
                </a>
              </div>
              <div className="flex items-center justify-center p-3 bg-gray-900/30 rounded-lg hover:bg-gray-900/50 transition-all duration-300 group">
                <a
                ...
                >
                  <PhoneIcon size={28} />
                  <span className="text-purple-400 group-hover:text-purple-300 transition-colors duration-300 font-medium">
                    +1 (651) 440-8356
                  </span>
                </a>
              </div>
